...
class CharacterServiceTest {
  ...
  @Mock private SwapiRepository swapiRepository;

  @Mock private RedisTemplate<String, CharacterResponseDTO> characterRedisTemplate;

  @Mock private ListOperations<String, CharacterResponseDTO> listOperations;
  ...
  void testGetFavouriteCharacters() {
    ...
    when(listOperations.range("FAVOURITES:admin", 0, -1))
  ...
  void testAddFavouriteCharacterFailureThrowsException() {
    ...
    assertThrows(
        RuntimeException.class, () -> characterService.addFavouriteCharacter("admin", character));
  }
}
